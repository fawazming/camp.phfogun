    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
      <div class="grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <h1 class="text-4xl sm:text-5xl font-extrabold tracking-tight text-slate-900">Grow, Connect & Serve at <span class="bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-cyan-500">PMC Ogun State</span></h1>
          ...
          <div class="glass rounded-3xl p-6 border border-white/60 shadow-xl">
            <div class="grid grid-cols-2 gap-4">
              <div class="p-4 rounded-2xl bg-white shadow">
                ...
                <div class="font-semibold">December 22 - 27, 2025</div>
              </div>
              <div class="p-4 rounded-2xl bg-white shadow">
                <div class="text-xs text-slate-500">Venue</div>
                <div class="font-semibold">Mayflower School, Ikenne</div>
              </div>
              <div class="p-4 rounded-2xl bg-white shadow">
              ...
              <div class="p-4 rounded-2xl bg-white shadow">
                ...
                <div class="font-semibold">pmc@phfogun.org.ng</div>
              </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
          ...
          <p class="text-sm text-slate-600 mt-1">Register with email and category in minutes. Categories include professionals, undergraduates, school leavers and secondary school students.</p>
        </div>
        <div class="p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
  ...
  <section id="about" class="py-14 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid lg:grid-cols-2 gap-10 items-center">
        <div>
          <h3 class="text-2xl font-bold">About PMC</h3>
          <p class="mt-3 text-slate-600">PMC (Pure Heart Islamic Modelling Camp) brings youths and workers together for immersive learning, mentorship, worship and service. Our digital flow keeps things simple so you can focus on the experience.</p>
        ...
        <div class="grid sm:grid-cols-2 gap-4">
          ...
          <div class="p-5 rounded-2xl bg-white shadow border border-slate-200">
            ...
            <div class="text-lg font-semibold">Professional • Undergraduate • School Leaver • SSS</div>
          </div>
          <div class="p-5 rounded-2xl bg-white shadow border border-slate-200">
            <div class="text-xs text-slate-500">Support</div>
          ...
          <div class="p-5 rounded-2xl bg-white shadow border border-slate-200">
            ...
            <div class="text-lg font-semibold">pmc@phfogun.org.ng</div>
          </div>
        </div>
      </div>
    </div>
